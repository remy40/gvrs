 ...
 */
	...
	'ElggPlugin:Exception:CannotRegisterClasses' => "Impossible d'enregistrer des classes pour plugin %s (GUID :%s) sur %s. Vérifiez les autorisations!",
 ...
 */
	...
	'admin:plugins:simple:cannot_activate' => "Impossible d'activer ce plugin. Vérifiez la partie plugin d'administration pour plus d'informations.",
