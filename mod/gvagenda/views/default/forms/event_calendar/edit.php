...
$required_fields = array('title','venue','start_date', 'brief_description');
...
if ($event_calendar_times != 'no') {
	...
	if ($event_calendar_hide_end != 'yes') {
		$body .= '</p><p><label>'.elgg_echo('event_calendar:to_label').'</label>'.$suffix['end_date'];
...
if ($event_calendar_spots_display == 'yes') {
	...
	$body .= '</label></p>';
//	$body .= '<p class="description">'.elgg_echo('event_calendar:spots_description').'</p>';
}
...
if ($event_calendar_personal_manage == 'by_event') {
	$body .= '<p><label>'.elgg_echo('event_calendar:personal_manage:label').$suffix['personal_manage'].'<br />';
	$body .= elgg_view("input/radio",array('name' => 'personal_manage','value'=>$personal_manage,'options'=>$personal_manage_options));
	$body .= '</label></p>';
//	$body .= '<p class="description">'.elgg_echo('event_calendar:personal_manage:description').'</p>';
}

//$body .= '<p><label>'.elgg_echo("event_calendar:event_tags_label").$suffix['event_tags'].'<br />';
