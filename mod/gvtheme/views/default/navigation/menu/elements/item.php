 ...
 * @uses $vars['section_class'] Additional CSS class for the children item
 */
...
$child_section_classes = "";
if (isset($vars['section_class'])) {
    $section_classes = explode(" ", $vars['section_class']);
    foreach($section_classes as $section_class) {
        $child_section_classes .= $section_class."-child ";
    }
}
...
if ($children) {
	echo elgg_view('navigation/menu/elements/section', array(
		'items' => $children,
		'class' => 'elgg-menu elgg-child-menu ' . $child_section_classes,
	));
}
echo '</li>';
