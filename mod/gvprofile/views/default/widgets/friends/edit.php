...
$params = array(
	'name' => 'params[show_type]',
	'value' => $vars['entity']->show_type,
	'options_values' => array(
		'gallery' => elgg_echo('gvprofile:gallery'),
		'list' => elgg_echo('gvprofile:list'),
	),
);
$show_dropdown = elgg_view('input/dropdown', $params);
...
<p>
	<?php echo elgg_echo('friends:show_type'); ?>:
	<?php echo $show_dropdown; ?>
</p>
