...
border: 0px;
text-align: center;
background-image:url('<?php echo $config->freichat_theme; ?>/<?php echo $chatroom_head; ?>');
}
...
background-image:url('<?php echo $config->freichat_theme; ?>/<?php echo $chatroomimg; ?>');
}

.frei_chatroomleftpanel {
float:left;
background-image:url('<?php echo $config->freichat_theme; ?>/<?php echo $chatroom_leftpanel; ?>');
width:348px;
}
...
background-image:url('<?php echo $config->freichat_theme; ?>/<?php echo $chatroom_selected; ?>');
display: block;
font-family: "Lucida Grande",Verdana,Arial,"Bitstream Vera Sans",sans-serif;
font-size: 11px;
padding-bottom: 7px;
