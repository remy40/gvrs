...
//------------------------------------------------------------------------------     
    public function get_users() {
				...
				$query = "SELECT DISTINCT f.`status_mesg`,f.`username`,f.`session_id`,f.`status`,f.`guest`,u.`nick`
...
//------------------------------------------------------------------------------ 		
    public function get_buddies() {
        ...
        $query = "SELECT DISTINCT f.`status_mesg`,f.`username`,f.`session_id`,f.`status`,f.`guest`
