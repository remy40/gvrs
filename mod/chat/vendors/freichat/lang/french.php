...
//english_informal.php
    ...
    $frei_trans['set_custom_mesg']   =       'Définir un message personnalisé:';
    $frei_trans['chat_room_title'] = 'Salons';
    $frei_trans['chat_message_me'] = 'Moi';
    $frei_trans['chat_status'] = 'Utilisateur hors-ligne. Les messages lui seront délivrés quand il sera de nouveau en ligne.';
    $frei_trans['rtl'] = 'basculer en texte RTL';
    $frei_trans['profilelink'] = 'Voir profil';
    $frei_trans['ban_mesg'] = 'Vous êtes banni';
    $frei_trans['chatroom_label']='Salon';
    $frei_trans['no_search_results'] = 'Aucun résultat!';
