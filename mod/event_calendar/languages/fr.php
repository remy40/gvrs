<?php
	...
	'event_calendar:brief_description_description' => "Une courte phrase.",
	'event_calendar:venue_label' => "Lieu",
	'event_calendar:venue_description' => "Ou l'événement a lieu ?",
	'event_calendar:start_date_label' => "Date de début",
	'event_calendar:start_date_description'	=> "Quand l'événement débute?",
	'event_calendar:end_date_label' => "Date de fin",
	'event_calendar:end_date_description'	=> "Quand l'événement prend fin? (par défaut, la date de début).",
	'event_calendar:start_time_label' => "Heure de début",
	'event_calendar:start_time_description'	=> "A quelle heure l'événement débute?",
	'event_calendar:end_time_label' => "Heure de fin",
	'event_calendar:end_time_description'	=> "A quelle heure l'événement prend fin?",
