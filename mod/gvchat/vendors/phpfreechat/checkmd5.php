...
$files_ok = array();
$files_ko = array();
if (md5(file_get_contents("./version.txt")) == "25198dbbb5f787214992c13a596f5751")
...
";
if (md5(file_get_contents("./data/public/.gitignore")) == "6e307a717ffad33ef493fbf9b8c680ad")
  $files_ok[] = "<span style=\"color:#3A3\">ok - ./data/public/.gitignore</span>
";
else
  $files_ko[] = "<span style=\"color:#F33\">corrupted - ./data/public/.gitignore (please replace this file by a correct one)</span>
";
...
";
if (md5(file_get_contents("./data/private/.gitignore")) == "2dd40cf46ceaf0c62d444dc709179728")
  $files_ok[] = "<span style=\"color:#3A3\">ok - ./data/private/.gitignore</span>
";
else
  $files_ko[] = "<span style=\"color:#F33\">corrupted - ./data/private/.gitignore (please replace this file by a correct one)</span>
";
